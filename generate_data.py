...
def build_pitcher_section(name, person_id, today):
    ...
    return {
        ...
        "last_30_games": mlb_data.get_pitcher_last_n_games_split(person_id, SEASON, 30),
        "last_15_games": mlb_data.get_pitcher_last_n_games_split(person_id, SEASON, 15),
        "last_7_games": mlb_data.get_pitcher_last_n_games_split(person_id, SEASON, 7),
    }
...
def build_pitcher_group(names, roster, today):
    ...
    if ids:
        ...
        section = {"New York Yankees (Team)": aggregate, **section}
    return section
